export const ADMIN_EMAIL_TIPO_ENVIO = {
  ...
  ASAMBLEA_CONVOCATORIA_SELECTIVA: "ASAMBLEA_CONVOCATORIA_SELECTIVA",
  ASAMBLEA_CANCELACION: "ASAMBLEA_CANCELACION",
  ASAMBLEA_SIMULACION_ADMIN: "ASAMBLEA_SIMULACION_ADMIN",
  ASAMBLEA_CANCELACION_SIMULACION_ADMIN: "ASAMBLEA_CANCELACION_SIMULACION_ADMIN",
} as const;
